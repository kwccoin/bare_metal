...
%include "osdev11-Stage2-stdio.inc"			; basic i/o routines
%include "osdev11-Stage2-Gdt.inc"			; Gdt routines
%include "osdev11-Stage2-A20.inc"			; A20 enabling
%include "osdev11-Stage2-Fat12.inc"			; FAT12 driver. Kinda :)
%include "osdev11-Stage2-common.inc"
