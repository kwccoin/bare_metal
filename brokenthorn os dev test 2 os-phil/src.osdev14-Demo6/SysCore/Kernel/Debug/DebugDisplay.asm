; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.762 
	...
	TITLE	d:\2016-05-25f-win-osdev14-Demo6_1\osdev14-Demo6\SysCore\Kernel\DebugDisplay.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File d:\2016-05-25f-win-osdev14-demo6_1\osdev14-demo6\syscore\kernel\debugdisplay.cpp
...
; 186  : 						char str[32]={0};
	...
	xor	eax, eax
	add	esi, 4
	mov	DWORD PTR _str$2649[esp+49], eax
	mov	DWORD PTR _str$2649[esp+53], eax
	...
	mov	WORD PTR _str$2649[esp+77], ax
	mov	BYTE PTR _str$2649[esp+79], al

; 187  : 						itoa_s (c, 16, str);

	mov	eax, DWORD PTR [esi]
	cmp	eax, ebx
	mov	BYTE PTR _str$2649[esp+48], bl
	lea	ecx, DWORD PTR _str$2649[esp+48]
	jge	SHORT $LN18@DebugPrint
	mov	BYTE PTR _str$2649[esp+48], 45		; 0000002dH
	lea	ecx, DWORD PTR _str$2649[esp+49]
	neg	eax
$LN18@DebugPrint:
	push	ecx
	push	16					; 00000010H
...
; 188  : 						DebugPuts (str);
	...
	lea	edx, DWORD PTR _str$2649[esp+60]
	push	edx
...
; 197  : 						char str[32]={0};
	...
	xor	eax, eax
	add	esi, 4
	mov	DWORD PTR _str$2659[esp+49], eax
	mov	DWORD PTR _str$2659[esp+53], eax
	...
	mov	WORD PTR _str$2659[esp+77], ax
	mov	BYTE PTR _str$2659[esp+79], al

; 198  : 						itoa_s (c, 10, str);

	mov	eax, DWORD PTR [esi]
	cmp	eax, ebx
	mov	BYTE PTR _str$2659[esp+48], bl
	lea	ecx, DWORD PTR _str$2659[esp+48]
	jge	SHORT $LN22@DebugPrint
	mov	BYTE PTR _str$2659[esp+48], 45		; 0000002dH
	lea	ecx, DWORD PTR _str$2659[esp+49]
	neg	eax
$LN22@DebugPrint:
	push	ecx
	push	10					; 0000000aH
...
; 199  : 						DebugPuts (str);
	...
	lea	eax, DWORD PTR _str$2659[esp+60]
	push	eax
...
; 208  : 						char str[32]={0};
	...
	xor	eax, eax
	add	esi, 4
	mov	DWORD PTR _str$2669[esp+49], eax
	mov	DWORD PTR _str$2669[esp+53], eax
	...
	mov	WORD PTR _str$2669[esp+77], ax
	mov	BYTE PTR _str$2669[esp+79], al

; 209  : 						itoa_s (c,16,str);

	mov	eax, DWORD PTR [esi]
	cmp	eax, ebx
	mov	BYTE PTR _str$2669[esp+48], bl
	lea	ecx, DWORD PTR _str$2669[esp+48]
	jge	SHORT $LN26@DebugPrint
	mov	BYTE PTR _str$2669[esp+48], 45		; 0000002dH
	lea	ecx, DWORD PTR _str$2669[esp+49]
	neg	eax
$LN26@DebugPrint:
	push	ecx
	push	16					; 00000010H
...
; 210  : 						DebugPuts (str);
	...
	lea	ecx, DWORD PTR _str$2669[esp+60]
	push	ecx
$LN36@DebugPrint:
